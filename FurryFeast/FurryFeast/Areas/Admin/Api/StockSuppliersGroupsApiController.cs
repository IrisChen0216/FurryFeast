...
namespace FurryFeast.Areas.Admin.Api {
    ...
    public class StockSuppliersGroupsApiController : ControllerBase {
        ...
        // 新增一筆資料
        [HttpPost]
        public async Task<IActionResult> PostData([FromBody] StockSuppliersGroupViewModel data) {
            if (_context.StockSuppliersGroups == null) {
                return NotFound("StockSuppliersGroups is null.");
            }
        ...
        // 更新一筆資料
        [HttpPatch]
        public async Task<IActionResult> PatchData([FromBody] StockSuppliersGroupViewModel data) {
            if (_context.StockSuppliersGroups == null) {
                return NotFound("StockSuppliersGroups is null");
            }
